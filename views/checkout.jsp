			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1">
						...
						<td class="invert-image"><a href="single.html"><img src="resources/images/1.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="single.html"><img src="resources/images/2.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem3">
						...
						<td class="invert-image"><a href="single.html"><img src="resources/images/3.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                           
									<div class="entry value-minus">&nbsp;</div>
